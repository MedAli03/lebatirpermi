...
<form action="<?php echo Route::_('index.php?option=com_batirpermi&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
...
<div class="table-responsive">
	...
	<tr>
		...
		<th scope="col">
			<?php echo HTMLHelper::_('searchtools.sort', 'COM_BATIRPERMI_CATEGORIES_CATEGORIE', 'a.title', $listDirn, $listOrder); ?>
		</th>		
		<th scope="col"><?php echo Text::_('Language'); ?></th>
		<th scope="col"><?php echo Text::_('id'); ?></th>

	</tr>
	</thead>
	<tbody>
	<?php foreach ($this->items as $i => $item) :
		$canChange = $user->authorise('core.edit.state', 'com_batirpermi.categorie.' . $item->id);
	?>
	<tr>
		...
		<td>
			<a href="<?php echo Route::_('index.php?option=com_batirpermi&task=categorie.edit&id=' . $item->id); ?>"
