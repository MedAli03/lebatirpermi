...
<div class="table-responsive">
	...
	<tr>
		...
		<th scope="col">
			<?php echo HTMLHelper::_('searchtools.sort', 'COM_BATIRPERMI_LEBATIRPERMIS_LEBATIRPERMI', 'a.title', $listDirn, $listOrder); ?>
		</th>
	...
	<tr>
		...
		<td>
			<a href="<?php echo Route::_('index.php?option=com_batirpermi&task=lebatirpermi.edit&layout=emploi&id=' . $item->id); ?>"
        ...
        <td><?php if($item->image) : ?>
        	<a href="<?php echo  Uri::root() . $item->image; ?>" target="_blank"><i class="far fa-file-alt"></i></a>
            <?php endif ;?>
        </td>
